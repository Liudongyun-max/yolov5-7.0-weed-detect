...
def parse_opt(known=False):
    ...
    parser.add_argument('--profile', action='store_true', default=True, help='total training epochs')
    parser.add_argument('--line-profile', action='store_true', default=True, help='total training epochs')
